...
app.put("/edit-story/:id", authenticateToken, async (req, res) => {
    ...
    try {
        // Find the travel storyby ID and ensure it belongs to the authenticated user
...
app.get("/travel-stories/filter", authenticateToken, async (req, res) => {
    ...
    try {
        ...
        // Find tarvel stories that belong to the authenticatred user and fall within the date range
